...
- ETH when protocol activity routes ETH into the engine

The NARA side is finite.
The ETH side can continue as long as the protocol creates useful ETH flow.
...
- `REWARDS.md` for how earning works
