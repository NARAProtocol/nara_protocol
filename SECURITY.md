...
Do not include private keys, seed phrases, stolen data, or unnecessary personal
information. Do not exploit the issue, access other users' assets, disrupt
services, perform social engineering, or test against production in a way that
could cause loss.

Receipt may be acknowledged, but no response time, payment, bounty, safe-harbor
protection, or resolution is promised unless separately confirmed in writing.
